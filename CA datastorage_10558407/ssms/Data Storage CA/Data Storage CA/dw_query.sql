...
FROM AMAZON_ORDER_SOURCE.dbo.Orders_source o;
...
INSERT INTO Calendar_dim(calendar_key, order_date, day_of_week, day_number, month_number, year_number)
SELECT DISTINCT date_id, order_date, DATENAME(dw, order_date) AS Weekday, 
DATEPART(day, order_date) AS day, DATEPART(month, order_date) AS month, DATEPART(year, order_date) AS year
FROM   AMAZON_ORDER_SOURCE.dbo.Orders_source